 ...
 *
 */
public class JPanel_Preconfiguradas extends JPanel {
    ...
    *
     */
    private static JPanel_Preconfiguradas panelConfiguradas;
    private C_Preconfiguradas controlador;
    ...
    *
     */
    public JPanel_Preconfiguradas(C_PCRT vent) {
        this.controlador = new C_Preconfiguradas(this, vent);
        initComponents();
    ...
    *
     */
    public static JPanel_Preconfiguradas abrir(C_PCRT vent) {
        if (panelConfiguradas == null) {
            panelConfiguradas = new JPanel_Preconfiguradas(vent);
        }
    ...
    *
     */
    public C_Preconfiguradas getControlador() {
        return controlador;
    }
    ...
    *
    ...
    private void initComponents() {
        ...
        jLabel_Info.setBackground(new java.awt.Color(102, 204, 255));
